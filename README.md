...
3. Download project from github(https://github.com/shivalucky2005/online-blood-banking-system).

   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/shivalucky2005/Blood-Bank-And-Donation-Management-System.git
